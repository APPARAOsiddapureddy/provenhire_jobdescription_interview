"""FastAPI app for the Proven Hire Job Description Interview knowledge sidecar (:9621).
...
def create_app(backend: RagBackend | None = None) -> FastAPI:
    ...
    app = FastAPI(title="Proven Hire Job Description Interview Knowledge Sidecar", version="0.0.0")
