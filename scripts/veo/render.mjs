#!/usr/bin/env node
/**
 * render.mjs — Proven Hire Job Description Interview avatar render CLI (WP-9).
 *
...
function printHelp() {
  console.log(
    [
      "Proven Hire Job Description Interview avatar render CLI (WP-9)",
      "",
      "Usage:",
...
function dryRun(personas, model) {
  const r2 = r2Config();
  console.log("");
  console.log("Proven Hire Job Description Interview · Veo 3.1 avatar render (DRY RUN)");
  console.log("================================================");
  console.log("");
