...
from proven_hire_agent.core.config import Settings
from proven_hire_agent.core.deps import build_deps
from proven_hire_agent.prep import cv_extract
from proven_hire_agent.prep.cv_extract import extract_cv_text
from proven_hire_agent.prep.nodes import fetch_cv
...
def test_fetch_cv_node_is_idempotent_even_when_text_empty(monkeypatch) -> None:
    ...
    monkeypatch.setattr("proven_hire_agent.prep.nodes.extract_cv_text", _boom)
