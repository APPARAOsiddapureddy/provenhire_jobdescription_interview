"""LiveKit Agents worker entrypoint for the Proven Hire Job Description Interview live voice loop (WP-5).
...
REQUIRES the optional ``livekit`` extra and live keys to RUN:
    ...
    python -m proven_hire_agent.worker dev      # or: start / connect
