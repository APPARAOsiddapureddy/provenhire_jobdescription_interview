...
export const en = {
  ...
  landing: {
    ...
    subtitle:
      "Proven Hire Job Description Interview reads your CV and the job, researches the company, then runs an adaptive voice interview — and shows you exactly what to fix.",
