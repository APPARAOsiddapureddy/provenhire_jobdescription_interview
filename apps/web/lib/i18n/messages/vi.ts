...
export const vi: Localized<Messages> = {
  common: {
    appName: "Proven Hire Job Description Interview",
    continue: "Tiếp tục",
    back: "Quay lại",
    cancel: "Hủy",
    loading: "Đang tải…",
  ...
  landing: {
    ...
    subtitle:
      "Proven Hire Job Description Interview đọc CV và mô tả công việc của bạn, tìm hiểu về công ty, sau đó chạy một buổi phỏng vấn bằng giọng nói linh hoạt — và chỉ ra chính xác điều cần cải thiện.",
