...
export const metadata: Metadata = {
  title: "Avatar system · Proven Hire Job Description Interview",
  description:
    "Preview the Proven Hire Job Description Interview avatar personas and their idle ⇄ speaking states.",
};
