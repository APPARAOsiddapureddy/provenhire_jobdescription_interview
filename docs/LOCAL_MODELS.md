# Run Proven Hire Job Description Interview on local models
...
llama.cpp, Speaches, kokoro-fastapi. Proven Hire Job Description Interview added no new dependency for
...
`pnpm proven-hire init` → **"100% local models"** sets all of this for you.
...
stage. Proven Hire Job Description Interview needs to own the LLM turn itself (the interviewer calls
...
builder in `apps/agent/src/proven_hire_agent/worker.py`
