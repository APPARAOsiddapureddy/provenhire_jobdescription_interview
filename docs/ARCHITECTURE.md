...
A concise tour of how Proven Hire Job Description Interview is put together. The build is organized as
13 work packages (WP-0…WP-13); their current status and scope are tracked in the
GitHub issues.

Proven Hire Job Description Interview is a voice-first AI mock-interview platform: it reads a
...
[`apps/agent/src/proven_hire_agent/core/adapters/`](../apps/agent/src/proven_hire_agent/core/adapters):
...
package each concerns (`apps/agent/src/proven_hire_agent/{prep,post,live}`,
